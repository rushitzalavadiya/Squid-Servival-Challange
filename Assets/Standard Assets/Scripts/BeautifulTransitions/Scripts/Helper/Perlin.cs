...
namespace BeautifulTransitions.Scripts.Helper
{
	public class Perlin
	{
		...
		{
			setup(x, out int b, out int b2, out float r, out float r2);
			setup(y, out int b3, out int b4, out float r3, out float r4);
			int num = p[b];
			int num2 = p[b2];
			int num3 = p[num + b3];
			int num4 = p[num2 + b3];
		...
		public float Noise(float x, float y, float z)
		{
			setup(x, out int b, out int b2, out float r, out float r2);
			setup(y, out int b3, out int b4, out float r3, out float r4);
			setup(z, out int b5, out int b6, out float r5, out float r6);
			int num = p[b];
			int num2 = p[b2];
			int num3 = p[num + b3];
			int num4 = p[num2 + b3];
